# Installation Policy - Aurora v0.6.4

## Escopo real da política

Na `v0.6.4`, a política operacional da Aurora governa dois domínios, três superfícies explícitas fora do host mutável comum e oito leituras reais de rota:
...
Na `v0.6.4`, `--confirm` e `--yes` são aceitos como marcadores equivalentes de confirmação explícita, inclusive quando entram inline na frase inspecionada.
