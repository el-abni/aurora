# Compatibilidade Linux - Aurora v0.6.4
...
Leitura correta desta frente na `v0.6.4`:
...
Na `v0.6.4`, `flatpak` continua sendo a frente explícita de software do usuário.
...
Na `v0.6.4`, `toolbox` entra como superfície operacional mediada, não como fonte.
...
Na `v0.6.4`, `distrobox` entra como segunda superfície operacional mediada, não como fonte.
...
Na `v0.6.4`, `rpm-ostree` entra como superfície explícita de host imutável.
