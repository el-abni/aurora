...
## Três camadas da v1.3.0

A `v1.3.0` preserva três camadas distintas:
...
- a disciplina operacional preservada na `v1.3.0`;
...
- `audit_workflow_release.py` protege o workflow disciplinado da `v1.3.0`;
- `test_conversation_mediation.py` protege tópicos e perguntas fechadas da `v1.2.0`;
- `test_source_clarification.py` protege clarificação controlada, bloqueios pré-executor e preservação de comandos operacionais existentes da `v1.3.0`;
