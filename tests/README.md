...
## Três camadas da v1.1.0

A `v1.1.0` preserva três camadas distintas:
...
- a disciplina operacional preservada na `v1.1.0`.
...
- `audit_workflow_release.py` protege o workflow disciplinado da `v1.1.0`;
